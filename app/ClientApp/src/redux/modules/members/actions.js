...
export const createMemberPointsSuccess = (newLocation) => {
  return {
    type: CREATE_MEMBER_POINTS_SUCCESS,
    payload: newLocation
  }
}
...
export const editMemberPointsSuccess = (editedLocation) => {
  return {
...
export const deleteMemberPointsSuccess = (deletedLocation) => {
  return {
